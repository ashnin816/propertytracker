...
type View = "home" | "space" | "units" | "unit" | "item" | "settings";
    ...
    <div className="h-screen flex overflow-hidden">
      ...
      <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-72 bg-white dark:bg-[#111827] border-r border-gray-200/60 dark:border-gray-800 flex flex-col transition-transform duration-300 lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
        ...
        <div className="h-14 px-4 flex items-center justify-between border-b border-gray-200/60 dark:border-gray-800 flex-shrink-0">
          ...
          {authUser && (
            <button onClick={() => { setView("settings"); setSelectedSpaceId(null); setSidebarOpen(false); }}
              title="Settings"
              className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-[10px] font-bold no-min-size cursor-pointer transition-all ${
                view === "settings" ? "ring-2 ring-blue-500 ring-offset-2 dark:ring-offset-[#0c1222]" : "hover:ring-2 hover:ring-gray-300 dark:hover:ring-gray-600"
              } bg-blue-600`}>
        ...
        <header className="h-14 px-4 flex items-center justify-between border-b border-gray-200/60 dark:border-gray-800 bg-white/90 dark:bg-[#0c1222]/90 backdrop-blur-xl flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              {view === "settings" && <h1 className="text-base font-semibold dark:text-white">Settings</h1>}
